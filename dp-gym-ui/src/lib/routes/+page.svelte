<script lang="ts">
	...
	import { formatDate, formatNumber } from 'stwui/utils';
	import type { CarouselSlide, LightboxAction } from 'stwui/types';
	import { close, arrow_forward, thumb_up, comment, share, file_document, folder, home, send, trash } from '../lib/icons';
